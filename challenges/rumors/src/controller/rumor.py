...
from challenges.rumors.src.dto.serializers import rumor, page_of_rumors, blog_post, page_of_blog_posts
...
from challenges.rumors.src.database.models import Post
