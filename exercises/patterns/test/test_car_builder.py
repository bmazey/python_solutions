import exercises.patterns.builder.car_builder_director

def test_construct_suv():
    car = exercises.patterns.builder.car_builder_director.CarBuilderDirector.construct_suv()
    assert car.wheels == 4
    assert car.doors == 4
...
def test_construct_sports_car():
    car = exercises.patterns.builder.car_builder_director.CarBuilderDirector.construct_sports_car()
    assert car.wheels == 4
    assert car.doors == 2
...
def test_construct_eighteen_wheeler():
    car = exercises.patterns.builder.car_builder_director.CarBuilderDirector.construct_eighteen_wheeler()
...
def test_construct_tesla():
    car = exercises.patterns.builder.car_builder_director.CarBuilderDirector.construct_tesla()
    assert car.wheels == 4
    assert car.doors == 4
